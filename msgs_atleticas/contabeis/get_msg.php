<?php
	...
	$sql.= " FROM msg_contabeis AS t JOIN usuarios AS u ON (t.id_usuario = u.id) ";
	...
	if($resultado_id){
		...
		while($registro = mysqli_fetch_array($resultado_id, MYSQLI_ASSOC)){
			...
			echo '<img src="img/contabeis_avatar.jpg" alt="" class="circle responsive-img valign profile-post-uer-image">';                        
			echo '</div>';
