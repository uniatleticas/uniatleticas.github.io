...
<head>
    ...
    <script type="text/javascript">
			...
			$(document).ready( function(){
				...
				$('#btn_msg').click( function(){
					...
					if($('#texto_msg').val().length > 0){
						...
						$.ajax({
							url: 'msgs_atleticas/si/inclui_msg.php',
							method: 'post',
				...
				function atualizaMsg(){
					...
					$.ajax({
						url: 'msgs_atleticas/si/get_msg.php',
						success: function(data) {
							$('#msgs').html(data);
						}
					});
        ...
        function carregaMembros(){
					...
					$.ajax({
						url: 'msgs_atleticas/si/get_membros.php',
						success: function(data) {
							$('#users').html(data);
						}
					});
          ...
          <div id="profile-page" class="section">
            ...
            <div id="profile-page-header" class="card">
                <div class="card-image waves-effect waves-block waves-light">
                    <img class="activator" src="img/capas/si_atletica.png" alt="user background">                    
                </div>
                <figure class="card-profile-image">
                    <img src="img/si_avatar.jpg" alt="profile image" class="circle z-depth-2 responsive-img activator">
                </figure>
                <div class="card-content">
                  <div class="row">                    
                    <div class="col s3 offset-s2">
                    <h4 class="card-title grey-text text-darken-4">Atlética de Sistemas de Informação - AAASIU</h4>                       
                    </div>                  
                  </div>
                </div>
                ...
                <div id="profile-page-wall-share" class="row">
                  <div class="col s12">
                    ...
                    <div id="UpdateStatus" class="tab-content col s12  grey lighten-4">
                      <div class="row">
                        <div class="col s2">
                          <img src="img/si_avatar.jpg" alt="" class="circle responsive-img valign profile-image-post">
                        </div>
